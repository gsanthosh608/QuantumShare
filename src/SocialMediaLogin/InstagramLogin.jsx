...
import { setInstaLoggedIn } from '../Redux/action/dataslice';
...
const InstagramLogin = () => {
    ...
    const { instaLoggedIn } = useSelector((state) => state.data)
    console.log(instaLoggedIn)
            ...
            <section className='box-soc' style={{ paddingTop: '20px' }}>
                ...
                {loading || disconnecting ? (
                    ...
                    !instaLoggedIn ? (
                        ...
                        <Button variant='contained' sx={{ marginTop: '15px', marginBottom: '10px', fontWeight: '600' }} onClick={handleDisconnect}>Disconnect</Button>
                    )
                )}
            </section>
