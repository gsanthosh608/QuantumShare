...
//     const instaLoggedIn = useSelector((state) => state.data.instaLoggedIn);
//     const telLoggedIn = useSelector((state) => state.data.telLoggedIn);

//     const pageUrls=useSelector((state)=>(state.data.pageUrls));
//     console.log(pageUrls);
    

//     const mediaPlatforms = [
//         { id: 'facebook', icon: facebook1, name: 'Facebook', isLoggedIn },
//         { id: 'instagram', icon: instagram1, name: 'Instagram', isLoggedIn: instaLoggedIn },
//         { id: 'telegram', icon: telegram1, name: 'Telegram', isLoggedIn: telLoggedIn },
//     ];
